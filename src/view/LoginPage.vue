					...
					<div class="col-md-4 login-sec">
                        ...
                        <form class="login-form">
                            <div class="form-group">
								...
								<span v-if="statusError.username" class="text-danger">*Please enter Username*</span>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1" class="text-uppercase">Password</label>
                                <input v-model="user.password" type="password" class="form-control" placeholder="">
								<span v-if="statusError.password" class="text-danger">*Please enter Password*</span>
