<template>
    <div class="">
        ...
        <div class="" style="padding: 50px; background-color: black; color: white;">
            <table>
                <thead>
                  <tr>
                    <th>Id</th>
                ...
                <tbody>
                  <tr v-for="(movie,index) in list_movie" :key="movie._id">
                    ...
                    <td style="padding: 0px !important;" width="180px"><p class="text" style="color: white; font-size: 16px;">
                     {{ movie.description }}</p></td>
                    
                    <td> 
                        <button @click="handlerClickEditMovie(movie._id)" class="" style="color: white;background: blue;border-radius: 8px;transition: .2s ease-in-out;border: none;padding: 5px;" type="button"> Edit</button> 
                        <button @click="handlerClickDetele(movie._id)" class="" style="color: white;background: red;border-radius: 8px;transition: .2s ease-in-out;border: none;padding: 5px;margin-left: 5px;" type="button"> Detele</button> 
                    </td>
                  </tr>
