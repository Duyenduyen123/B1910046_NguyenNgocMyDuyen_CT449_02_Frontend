              ...
              <h5 v-else>Page update movie</h5>
                <form>
                  <div class="form-group">
                      ...
                      <span v-if="statusError.title" class="text-danger">*Please enter movie name*</span>
                  </div>
                  <div class="form-group">
                      ...
                      <span v-if="statusError.category" class="text-danger">*Please enter movie types*</span>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Link Video *</label>
                    <input v-model="movie.link_url" type="text" class="form-control" >
                    <span v-if="statusError.link_url" class="text-danger">*Please enter video link*</span>
                  </div>
                  <div class="form-group">
                  ...
                  />
                    <span v-if="statusError.image" class="text-danger">*Please enter an image*</span>
                  </div>
                  <div class="form-group">
                      <label for="exampleFormControlTextarea1">Description</label>
                      <textarea  class="form-control" id="exampleFormControlTextarea1" rows="3" v-model="movie.description"></textarea>
                  </div>
                  <button v-if="!status_update"  style="color: white;background: blue;border-radius: 8px;transition: .2s ease-in-out;border: none;padding: 5px;" @click="handlerClickSubmit($event)">Submit</button>
                  <button v-else style="color: white;background: blue;border-radius: 8px;transition: .2s ease-in-out;border: none;padding: 5px;" @click="handlerClickUpdate($event,movie._id)">Update</button>
              </form>
              </div>
