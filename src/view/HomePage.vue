                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div style="margin-bottom: 12px;">
                            <form><input class="input_search" v-model="search_query" type="text" placeholder="Enter keywords"><button class="btn_search" @click="handlerClickSearch($event)" style="background-color: blue;">Search</button></form>
                        </div>
