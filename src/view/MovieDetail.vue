                                        ...
                                        <div id="overview" class="tab active">
                                            ...
                                            <div class="row">
                                                <div class="hs-responsive-embed-youtube">
                                                    <iframe width="700" height="315" :src="'https://www.youtube.com/embed/'+movie.link_url" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                                    <!-- <iframe
                                                        width="560"
                                                        height="315"
